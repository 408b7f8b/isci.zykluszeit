...
namespace isci.zykluszeit
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            new Modul(konfiguration.Identifikation, "isci.zykluszeit", new ListeDateneintraege() { zykluszeit, zykluszeit_max })
            {
                Name = "Zykluszeit Ressource " + konfiguration.Identifikation,
                Beschreibung = "Modul zur Zykluszeitermittlung"
            }.Speichern(konfiguration.OrdnerBeschreibungen + "/" + konfiguration.Identifikation + ".json");
